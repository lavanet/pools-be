...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_QUOTAOPERATION_LABELSENTRY']._serialized_options = b'8\001'
  _globals['_QUOTACONTROLLER']._loaded_options = None
  _globals['_QUOTACONTROLLER']._serialized_options = b'\312A\035servicecontrol.googleapis.com\322A]https://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/servicecontrol'
  _globals['_QUOTACONTROLLER'].methods_by_name['AllocateQuota']._loaded_options = None
  _globals['_QUOTACONTROLLER'].methods_by_name['AllocateQuota']._serialized_options = b'\202\323\344\223\002.\")/v1/services/{service_name}:allocateQuota:\001*'
