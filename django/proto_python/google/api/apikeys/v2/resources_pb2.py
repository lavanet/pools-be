...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_KEY_ANNOTATIONSENTRY']._serialized_options = b'8\001'
  _globals['_KEY'].fields_by_name['name']._loaded_options = None
  _globals['_KEY'].fields_by_name['name']._serialized_options = b'\340A\003'
  _globals['_KEY'].fields_by_name['uid']._loaded_options = None
  _globals['_KEY'].fields_by_name['uid']._serialized_options = b'\340A\003'
  _globals['_KEY'].fields_by_name['key_string']._loaded_options = None
  _globals['_KEY'].fields_by_name['key_string']._serialized_options = b'\340A\003'
  ...
  _globals['_KEY'].fields_by_name['update_time']._serialized_options = b'\340A\003'
  _globals['_KEY'].fields_by_name['delete_time']._loaded_options = None
  _globals['_KEY'].fields_by_name['delete_time']._serialized_options = b'\340A\003'
  _globals['_KEY'].fields_by_name['etag']._loaded_options = None
  _globals['_KEY'].fields_by_name['etag']._serialized_options = b'\340A\003'
  _globals['_KEY']._loaded_options = None
  _globals['_KEY']._serialized_options = b'\352A^\n\032apikeys.googleapis.com/Key\0222projects/{project}/locations/{location}/keys/{key}*\004keys2\003keyR\001\001'
  _globals['_APITARGET'].fields_by_name['methods']._loaded_options = None
  _globals['_APITARGET'].fields_by_name['methods']._serialized_options = b'\340A\001'
